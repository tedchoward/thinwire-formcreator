...
enum Widget {    
    ...
    DIALOG(DialogWindow.class, 350, 250),
    ...
    Widget(Class type, int defaultWidth, int defaultHeight, String sideText) {
        ...
        for (PropertyEditor prop : PropertyEditorFactory.getPropertyEditors(Component.class)) {                        
    ...
    String getNextId() {
        return Main.getSimpleClassName(getType()).toLowerCase() + "_" + nextId++;
    }
    ...
    Component newInstance() {
        ...
        if (comp instanceof Image) {
            ((Image)comp).setImage("http://www.thinwire.com/img/barlogo.png");
        } else if (comp instanceof Hyperlink) {
            ((Hyperlink)comp).setLocation("http://www.thinwire.com/img/barlogo.png");
        ...
        comp.setSize(this.getDefaultWidth(), this.getDefaultHeight());
        return comp;
    }
