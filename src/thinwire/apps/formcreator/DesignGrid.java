 ...
 */
public class DesignGrid extends Label implements DesignTimeComponent {
    public DesignGrid() {
        getStyle().getBackground().setImage(Main.RES_PATH + "DesignGrid.png");
        getStyle().getBackground().setRepeat(Background.Repeat.BOTH);
        getStyle().getBackground().setPosition(Background.Position.LEFT_TOP);
    }
}
