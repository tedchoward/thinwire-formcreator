 ...
 */
public class FilePropertyEditor extends AbstractPropertyEditor<ProjectDefinition> {
    FilePropertyEditor(String name, Class type) {
        init(XODFile.class, type, name, "General");
